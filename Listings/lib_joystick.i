...
void joystick_init(void)
{
    ...
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINMODE3 &= ~(
        (3 << 18) | // P1.25
        (3 << 20) | // P1.26
        (3 << 22) | // P1.27
        (3 << 24) | // P1.28
...
void HandleJoystickInput(void) {
    ...
    press_up = !(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 29)); // UP
    down_pressed = !(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 26)); // DOWN
    press_left = !(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 27)); // LEFT
    press_right = !(((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 28)); // RIGHT
}
