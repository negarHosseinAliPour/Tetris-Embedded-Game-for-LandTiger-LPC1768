...
# 1 "C:\\Users\\negar\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdlib.h" 1 3
# 71 "C:\\Users\\negar\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdlib.h" 3
...
// 1. SPAWN POWERUP (your original working version)
void spawn_powerup(void) {
  GUI_Text(10, 30, (uint8_t *)"POWERUP SPAWNED", 0x7FFF, 0x0000);
...
// HALF-CLEAR: Clear bottom half (10-19), SPEC 2 scoring
void half_clear_powerup(void) {
    int i,j;
    int line_count = 0;
    int k, row;
    // Check bottom half (rows 10-19) for full lines
    for(i=19; i>=10; i--) {
        int full_line = 1;
        ...
        // Clear full line (like normal clear_line)
        if(full_line == 1) {
    ...
    // SPEC 2 SCORING - Groups of 4 lines (like your freeze_shape scoring)
  if (line_count > 0) {
...
// SLOW-DOWN: 15 seconds at 1 square/second
void slowdown_powerup(void) {
    slowdown_active = 1;
    // Timer interrupt will reset after ~15 seconds (750 timer ticks at 50ms)
}
...
void spawn_malus_line(void)
{
  ...
  GUI_Text(140, 270, (uint8_t*)"MALUS LINE!", 0xF800, 0x0000);
