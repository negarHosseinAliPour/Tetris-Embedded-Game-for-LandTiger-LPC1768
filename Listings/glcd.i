...
# 1 "C:/Users/negar/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.1/Device/Include\\LPC17xx.h" 1
# 41 "C:/Users/negar/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.1/Device/Include\\LPC17xx.h"
typedef enum IRQn
{
...
# 106 "C:/Users/negar/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.1/Device/Include\\LPC17xx.h"
...
# 1 "C:\\Users\\negar\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdint.h" 1 3
# 56 "C:\\Users\\negar\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdint.h" 3
...
# 107 "C:/Users/negar/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.1/Device/Include\\LPC17xx.h" 2
# 1 "C:/Users/negar/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.1/Device/Include\\system_LPC17xx.h" 1
# 49 "C:/Users/negar/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.1/Device/Include\\system_LPC17xx.h"
...
# 108 "C:/Users/negar/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.1/Device/Include\\LPC17xx.h" 2
# 120 "C:/Users/negar/AppData/Local/Arm/Packs/Keil/LPC1700_DFP/2.7.1/Device/Include\\LPC17xx.h"
typedef struct
{
...
# 1 "C:\\Users\\negar\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\string.h" 1 3
# 51 "C:\\Users\\negar\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\string.h" 3
...
# 1 "C:\\Users\\negar\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdio.h" 1 3
# 68 "C:\\Users\\negar\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\stdio.h" 3
...
# 126 "Source/GLCD/GLCD.c"
static void wait_delay(int count)
{
 while(count--);
}
# 139 "Source/GLCD/GLCD.c"
...
# 264 "Source/GLCD/GLCD.c"
static void LCD_SetCursor(uint16_t Xpos,uint16_t Ypos)
{
# 277 "Source/GLCD/GLCD.c"
  switch( LCD_Code )
  {
     default:
...
{
    GUI_Text(140, 300, (uint8_t *)"                ", 0x0000, 0x0000);
    GUI_Text(140, 300, (uint8_t *)msg, 0xFFE0, 0x0000);
}
...
void draw_grids(uint16_t row, uint16_t column, uint16_t color){
 ...
 int i,j;
 for ( i=0;i<= row; i++){
   LCD_DrawLine(10, 60 +i*12, 10 +column*12, 60 +i*12, color);
 }

 for ( j=0; j<=column ;j++){
  LCD_DrawLine(10 +j*12, 60 ,10 + j*12, 60 +row*12, color);
 }
...
void LCD_DrawSquare (uint16_t x, uint16_t y, uint16_t color)
{
    ...
    // 1. draw normal block (original color)
    for (i = 1; i < 12; i++) {
        for (j = 1; j < 12; j++) {
            LCD_SetPoint(10 + x*12 + i,
                         60 + y*12 + j,
                         color);
        }
    }

    // 2. overlay powerup marker (WHITE)
    if (placed_powerup[y][x] != 0) {
        int cx = 10 + x*12 + 12/2;
        int cy = 60 + y*12 + 12/2;

        // white plus sign
        LCD_SetPoint(cx, cy, 0x0000);
        LCD_SetPoint(cx-1, cy, 0x0000);
        LCD_SetPoint(cx+1, cy, 0x0000);
        LCD_SetPoint(cx, cy-1, 0x0000);
        LCD_SetPoint(cx, cy+1, 0x0000);
    }
}
...
void gameover(void)
{
  ...
  if(Score> highest_Score){
    ...
    GUI_Text(140,130, (uint8_t *)scoreStr, 0xFFFF, 0x0000);
    stop_music();
    bg_active = 0;


  }
    GUI_Text(60, 150, (uint8_t*)"GAME OVER,", 0xF800, 0x0000);
  GUI_Text(60, 170, (uint8_t*)"KEY1->NEW GAME,", 0xFFE0, 0x0000);
...
void new_game(void){
 ...
 //reset the powerup point so non of the cells have powerup point
  for(i=0;i<20;i++) // Go through every row (0 to 19)
   for(j=0;j<10;j++) // Go through every column (0 to 9)
        placed_powerup[i][j] = 0; // Set = 0 (no powerup)

  GUI_Text(140,170,(uint8_t*)"clearedLine: ",0xFFFF, 0x0000);
  GUI_Text(140,190,(uint8_t*)"0 ",0xFFFF, 0x0000);

  GUI_Text(140,230,(uint8_t*)"score: ",0xFFFF, 0x0000);
  GUI_Text(140,250,(uint8_t*)"0 ",0xFFFF, 0x0000);

  GUI_Text(140,110,(uint8_t *)"HighestScore:", 0xFFFF, 0x0000);
  char scoreStr[20];
  sprintf(scoreStr, "%d", highest_Score);
  GUI_Text(140,130, (uint8_t *)scoreStr, 0xFFFF, 0x0000);
  }
...
void freeze_shape(void)
{
  ...
  GUI_Text(140,250, (uint8_t *)scoreStr, 0xFFFF, 0x0000);
    ...
    if (cleared_lines > 0) {
        ...
        GUI_Text(140, 190, (uint8_t *)scoreStr, 0xFFFF, 0x0000);
