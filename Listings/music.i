...
volatile int bg_active = 0;

void init_audio(void)
{

    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 |= (1<<21);
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 &= ~(1<<20); // P0.26 AOUT
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR |= (1<<26); // optional debug
    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1<<21); // power DAC
}
...
// 4. rotate = short click

void play_rotate(void) {
 int i,j;
    for(i = 0; i < 100; i++) {
        ((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )->DACR = (i % 2) ? 512 : 0;
        for(j = 0; j < 30; j++);
    }
