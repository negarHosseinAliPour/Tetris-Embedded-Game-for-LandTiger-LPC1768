...
void TIMER0_IRQHandler(void)
{
    ...
    uint16_t v = SinTable[sineticks] / 16 // bigger = softer (try 32 if still loud);
    ((LPC_DAC_TypeDef *) ((0x40080000UL) + 0x0C000) )->DACR = (v << 6);
...
{
    disable_timer(0); // TEMPLATE-CRITICAL: stop tone
    disable_timer(1); // also stop duration timer
